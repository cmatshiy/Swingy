...
public abstract class Character {
    ...
    @Min(value = 0, message = "Attack should be greater than 0")
    protected int attack;

    @Min(value = 0, message = "Defense should be greater than 0")
    protected int defense;

    @Min(value = 1, message = "Hit points should be greater than 1")
